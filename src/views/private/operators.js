...
import UpdateOperatorDialog from "../../components/dialogs/updateOperator";
import CreateOperatorDialog from "../../components/dialogs/createOperator";
  ...
  return (
    <Box sx={{ height: "85vh", p: 2 }}>
      ...
      <DeleteOperatorDialog
        ...
        deleteURL={`operator/${selectedData.id}`}
